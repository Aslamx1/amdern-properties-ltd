...
export const Route = createFileRoute("/privacy-policy")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://amdernpropertiessmclimited.com/privacy-policy" },
      {
    ...
    links: [{ rel: "canonical", href: "https://amdernpropertiessmclimited.com/privacy-policy" }],
  }),
  component: () => (
    <InfoPage
      eyebrow="Legal"
